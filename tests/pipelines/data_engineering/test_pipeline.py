...
def test_data_science_pipeline(caplog):  # Note: caplog is passed as an argument
    ...
    pipeline = (
        create_de_pipeline()
        .from_nodes("data_engineering.merge_all_datasets")
        .to_nodes("data_engineering.reset_values_in_boolean_columns")
    )
    ...
    catalog.add_feed_dict(
        {
            ...
            "params:data_engineering.cols_to_remove": dummy_parameters[
                "cols_to_remove"
            ],
            "params:data_engineering.boolean_columns": dummy_parameters[
                "boolean_columns"
            ],
        }
    )
